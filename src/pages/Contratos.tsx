    ...
    <div className="space-y-6">
      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        ...
        <div className="flex gap-3">
          <Button variant="outline" className="gap-2"><Play className="h-4 w-4" />Faturar Lote</Button>
          <Button className="gap-2"><Plus className="h-4 w-4" />Novo Contrato</Button>
        </div>
      </div>

      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        <StatsCard title="Contratos Ativos" value="0" icon={FileText} variant="success" description="Em vigência" />
        <StatsCard title="MRR" value="R$ 0" icon={DollarSign} variant="info" description="Receita recorrente" />
        <StatsCard title="Renovações" value="0" icon={Calendar} variant="warning" description="Próximos 30 dias" />
        <StatsCard title="Pendentes Faturar" value="0" icon={Clock} variant="default" description="Este mês" />
      </div>
      ...
      <Tabs defaultValue="ativos" className="space-y-4">
          ...
          <Card>
            ...
            <CardContent>
              <div className="flex flex-col items-center justify-center py-12 text-center">
                ...
                <p className="text-sm text-muted-foreground/70 mt-1">Configure a integração com o Omie para visualizar os contratos</p>
              </div>
            </CardContent>
          </Card>
        </TabsContent>
          ...
          <Card>
            ...
            <CardContent>
              <div className="flex flex-col items-center justify-center py-12 text-center">
                ...
                <p className="text-sm text-muted-foreground/70 mt-1">Contratos próximos do vencimento aparecerão aqui</p>
              </div>
            </CardContent>
          </Card>
        </TabsContent>
        ...
        <TabsContent value="faturar" className="space-y-4">
          <Card>
            <CardHeader>
              <div className="flex items-center justify-between">
                <div><CardTitle>Faturamento Pendente</CardTitle><CardDescription>Contratos prontos para faturar este mês</CardDescription></div>
                <Button className="gap-2"><Play className="h-4 w-4" />Faturar Todos</Button>
              </div>
            </CardHeader>
            <CardContent>
              <div className="flex flex-col items-center justify-center py-12 text-center">
                ...
                <p className="text-sm text-muted-foreground/70 mt-1">Contratos prontos para faturar aparecerão aqui</p>
              </div>
            </CardContent>
          </Card>
        </TabsContent>
        ...
        <TabsContent value="historico" className="space-y-4">
          <Card>
            <CardHeader><CardTitle>Histórico de Faturamento</CardTitle><CardDescription>NFS-e emitidas para contratos</CardDescription></CardHeader>
            <CardContent>
              <div className="flex flex-col items-center justify-center py-12 text-center">
                <CheckCircle2 className="h-12 w-12 text-muted-foreground/50 mb-4" />
                <h3 className="font-medium text-muted-foreground">Nenhuma NFS-e no histórico</h3>
                <p className="text-sm text-muted-foreground/70 mt-1">NFS-e emitidas para contratos aparecerão aqui</p>
              </div>
            </CardContent>
          </Card>
        </TabsContent>
